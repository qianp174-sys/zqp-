...
const PROJECTS: Project[] = [
  {
    ...
    impact: {
      title: "数据反馈 · 取得了什么成果？",
      metrics: [
        { value: "95%+", label: "内容按时发布率", color: "oklch(0.68 0.055 35)" },
        { value: "30%", label: "学员报名率提升", color: "oklch(0.68 0.055 35)" },
        { value: "100+", label: "内容任务可视化管理", color: "oklch(0.52 0.060 35)" },
        { value: "3", label: "平台同步管理", color: "oklch(0.40 0.035 155)" },
      ],
