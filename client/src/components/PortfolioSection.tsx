...
const PROJECTS: Project[] = [
  {
    ...
    problem: {
      title: "项目背景 · 发现了什么痛点？",
      content: "书法班因学员仅剩6人，面临关闭。前任教师教学枯燥，学员积极性低，家长感觉「学无效果」，机构负责人续费不理想。目标：6个月内实现班级常态化满员，总学员≥40人，假期班提前售罄。",
      painPoints: [
        "学生：课堂枯燥、积极性低，参与感不足",
  ...
  {
    id: "leiao",
    title: "企业级 AI 需求调研与客户运营实践",
    subtitle: "协同项目负责人实地走访多家企业，结构化输出行业痛点，推动AI解决方案精准落地",
    company: "蕾奥人工智能科学研究院",
    period: "2024.11 — 2025.04",
    tags: ["需求调研", "用户访谈", "活动运营", "内容运营"],
    coverColor: "oklch(0.52 0.060 35)",
    coverIcon: "🤖",
    coverBg: "linear-gradient(135deg, oklch(0.960 0.010 75) 0%, oklch(0.930 0.018 75) 100%)",
    problem: {
      title: "项目背景 · AI 赋能企业的时代命题",
      content: "2025年全球企业级AI市场规模达581.1亿美元，预计2030年达4741.6亿美元（CAGR 52.17%）。中国企业AI应用全面转向规模化应用期，但约70%的企业面临「不愿转、不敢转、不会转」困境。IBM调研显示，过去三年仅约25%的AI项目达到预期ROI。研究院使命：聚焦AI赋能企业，帮助客户跨越转型鸿沟。",
      painPoints: [
        "数据质量与治理：数据不统一、难以打通，主流AI应用向数据层渗透要求更高",
        "系统整合困难：传统IT系统呈烟囱式架构，AI部署适配改造成本高",
        "人才结构性短缺：既懂技术又懂业务的复合型人才稀缺，AI人才缺口直接阻碍落地",
        "战略与投入失衡：缺乏清晰AI落地路线图，ROI难以预估导致投入谨慎",
      ],
    },
    solution: {
      title: "解决方案 · 三大模块协同推进",
      content: "三个并行模块全面覆盖调研、活动、传播：协同负责人实地走访企业输出结构化需求；策划并落地多场线下沙龙；统筹自媒体内容持续触达客户。",
      steps: [
        "🔍 企业走访+需求调研：协同负责人走访多家企业，结构化访谈记录，梳理痛点条目，输出《企业级AI应用需求调研手册》，成为内部方案研讨的直接输入",
        "🎪 线下沙龙全流程策划：制定执行清单，把控现场节奏，活动后复盘优化，形成多场企业用户沙龙可复用的SOP",
        "📱 新媒体内容运营：统筹视频号+公众号发布排期，同步技术动态与行业洞察，将技术洞察转化为客户可感知的价值语言，持续构建研究院品牌心智",
      ],
      flowChart: ["访谈设计", "→", "实地走访", "→", "痛点提炼", "→", "手册成案", "→", "沙龙落地", "→", "内容传播"],
    },
    deliverables: {
      title: "核心交付 · 产出了什么成果？",
      items: [
        { name: "企业级AI需求调研手册", desc: "结构化整理多家企业需求与痛点，成为内部方案研讨核心输入文件", icon: "📖" },
        { name: "结构化访谈纪要", desc: "将模糊痛点转化为「战略—技术—人才—治理」四层痛点体系", icon: "📝" },
        { name: "企业用户沙龙 SOP", desc: "含活动策划、现场控场、复盘迭代的全流程模板，可直接复用", icon: "🎤" },
        { name: "内容运营排期体系", desc: "视频号+公众号常态化发布，持续触达客户与合作伙伴", icon: "📱" },
      ],
    },
    impact: {
      title: "数据反馈 · 取得了什么成果？",
      metrics: [
        { value: "多家", label: "企业实地走访完成", color: "oklch(0.52 0.060 35)" },
        { value: "1本", label: "《企业级AI需求调研手册》产出", color: "oklch(0.68 0.055 35)" },
        { value: "多场", label: "线下企业用户沙龙落地", color: "oklch(0.68 0.055 35)" },
        { value: "100%", label: "需求可追溯、有文档支撑", color: "oklch(0.40 0.035 155)" },
      ],
      summary: "完成多家企业结构化访谈与需求梳理，输出《企业级AI应用需求调研手册》成为内部方案研讨核心输入文件；成功落地多场企业用户线下沙龙，形成从策划到复盘的全流程执行SOP；建立视频号+公众号常态化发布机制，持续构建研究院品牌心智。",
    },
  },
  {
    id: "campus",
    title: "知识付费团队全媒体运营体系搭建",
    subtitle: "从0到1建立抖音/小红书/视频号三平台运营SOP",
    company: "海文辉传媒",
    period: "持续运营（已完成从0到1搭建）",
    tags: ["SOP建设", "内容运营", "数据驱动", "多平台矩阵"],
    coverColor: "oklch(0.52 0.060 35)",
    coverIcon: "📱",
    coverBg: "linear-gradient(135deg, oklch(0.960 0.012 75) 0%, oklch(0.930 0.020 75) 100%)",
    problem: {
      title: "项目背景 · 发现了什么痛点？",
      content: "2025年知识付费行业进入存量竞争与精细化运营阶段，单纯卖课模式失效，用户更看重IP信任度、内容实用性与持续陪伴感。多平台矩阵运营成为标配，但团队面临三大核心困境。",
      painPoints: [
        "流程混乱：选题反复修改、素材管理混乱、剪辑返工率高达40%，导致频繁断更",
        "平台错配：同一内容全平台分发，忽视抖音/小红书/视频号各自的用户逻辑",
        "转化断层：内容播放量高但课程购买率低，缺乏从观看到报名的闭环设计",
        "效率瓶颈：每周仅能产出1-2条内容，无法支撑三大平台的稳定更新需求",
      ],
    },
    solution: {
      title: "解决方案 · 全流程SOP七步法",
      content: "从0到1建立并迭代完整的内容生产SOP，每一环节均有对应模板与工具，将看似创意驱动的内容生产拆解为可执行的标准化流程。",
      steps: [
        "Step1 选题评审：每周整理20-30个候选选题池，召开15分钟三方评审会，按S/A/B级排序",
        "Step2 脚本定稿：标准化脚本结构（钩子→痛点→干货→软植入→行动指令），500-800字口语化",
        "Step3 拍摄执行：集中拍摄2-3小时完成一周5-8条内容，批量生产降低单次成本",
        "Step4 剪辑制作：分平台适配（抖音竖屏快节奏/小红书精美封面/视频号情绪共鸣）",
        "Step5 多平台发布：飞书多维表格可视化排期管理，状态全程追踪",
        "Step6 数据分析：每周复盘播放量/完播率/互动率，拆解爆款与低效内容差异",
        "Step7 跟进转化：设计视频→私信→加群→课程报名的完整转化路径闭环",
      ],
    },
    deliverables: {
      title: "核心交付 · 产出了什么成果？",
      items: [
        { name: "选题排期表", desc: "含发布平台建议、预估时间、转化路径设计的周度排期文档", icon: "📅" },
        { name: "标准化脚本模板", desc: "覆盖钩子设计到行动指令的完整脚本结构，可直接复用", icon: "📝" },
        { name: "多平台发布SOP", desc: "抖音/小红书/视频号三平台差异化发布策略与质检清单", icon: "🚀" },
        { name: "数据复盘报告", desc: "每周输出本周数据复盘与下周选题建议，驱动持续优化", icon: "📊" },
      ],
    },
    impact: {
      title: "数据反馈 · 取得了什么成果？",
      metrics: [
        { value: "3x", label: "内容发布频率提升（每周6-8条）", color: "oklch(0.52 0.060 35)" },
        { value: "2-6x", label: "各平台单视频平均播放量增长", color: "oklch(0.68 0.055 35)" },
        { value: "-75%", label: "内容返工率（40%降至10%以下）", color: "oklch(0.40 0.035 155)" },
        { value: "+30%", label: "核心课程学员报名率提升", color: "oklch(0.68 0.055 35)" },
      ],
      summary: "通过全流程SOP建设，内容发布频率从每周1-2条提升至6-8条，三大平台稳定更新；单视频播放量增长2-6倍（抖音从2000到1.2万，小红书从500到3000）；内容返工率从40%降至10%以下；核心课程学员报名率提升30%，课程总收入增长45%。",
    },
  },
];
